...
@bot.tree.command(name="coins_daily",description="Claim your daily coin reward.")
...
@bot.tree.command(name="coins_top",description="Show the top 10 users by coins.")
...
@admin_group.command(name="xp_add",description="(Admin) Add XP to a user.")
@app_commands.describe(member="User to give XP to.",amount="Amount of XP to add (positive integer).")
...
@admin_group.command(name="xp_remove",description="(Admin) Remove XP from a user.")
@app_commands.describe(member="User to remove XP from.",amount="Amount of XP to remove (positive integer).")
...
@admin_group.command(name="xp_set",description="(Admin) Set a user's XP to an exact value.")
@app_commands.describe(member="User to modify.",amount="Exact XP total to set (0 or more).")
...
@admin_group.command(name="xp_show", description="(Admin) Show a user's XP and level.")
...
@admin_group.command(name="create_structure",description="Create recommended CEIL categories and channels.")
...
@admin_group.command(name="clean_channel",description="(Admin) Delete the last N messages in this channel.")
@app_commands.describe(
...
if __name__ == "__main__":
    ...
    bot.run(DISCORD_TOKEN) ephemeral=True)
    if amount > 500:
        amount = 500
